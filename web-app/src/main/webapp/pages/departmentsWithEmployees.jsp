...
<div class="container">
    <div class="row card">
        ...
        <hr>
        <div class="center">
            <p><a class="waves-effect waves-light btn" href="/web-app-1.0-SNAPSHOT/departments">Without employees</a>
            <a class="waves-effect waves-light btn" href="/web-app-1.0-SNAPSHOT/employees">Employees</a>
            <a class="waves-effect waves-light btn" href="/web-app-1.0-SNAPSHOT/departments/departmentsWithEmployees">Show all</a></p>
        </div>
    </div>
    <div class="row card">
        <div class="col s5">
